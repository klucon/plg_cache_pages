...
_translator.load_domain("plg_cache_pages", _PLUGIN_SRC_DIR / "plg_cache_pages" / "i18n")

from jinja2 import FileSystemLoader  # noqa: E402
from src.core.templates import admin_templates  # noqa: E402

_TEMPLATES_DIR = _PLUGIN_SRC_DIR / "plg_cache_pages" / "templates"
if not any(
...
from src.plugins.plg_cache_pages import admin as _cache_admin  # noqa: E402
from src.plugins.plg_cache_pages import setup as _cache_setup  # noqa: E402
from src.main import app as _cms_app  # noqa: E402

if not any(
    getattr(r, "path", "").startswith("/admin/plg_cache_pages")
    for r in _cms_app.routes
):
    _cms_app.include_router(_cache_admin.router)


class _StubRegistry:
    def register_router(self, *a, **kw) -> None:
        pass


_cache_setup(_StubRegistry())
